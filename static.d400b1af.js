...
var _Visibility = _interopRequireDefault(__webpack_require__(16));
...
var _swimmer = __webpack_require__(30);
...
// Imports
// Plugins
var plugins=[{location:"D:/dev/cidr.xyz/node_modules/react-static-plugin-sass",plugins:[],hooks:{}},{location:"D:/dev/cidr.xyz",plugins:[],hooks:{}}];// Export em!
...
if (typeof document !== 'undefined') {
  // Polyfill that shiz!
  __webpack_require__(31); // Do manual polling for intersections every second. This isn't very fast
...
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(24);
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(path__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(25);
/* harmony import */ var babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var D_dev_cidr_xyz_node_modules_react_universal_component_dist_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var D_dev_cidr_xyz_node_modules_react_universal_component_dist_index_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(D_dev_cidr_xyz_node_modules_react_universal_component_dist_index_js__WEBPACK_IMPORTED_MODULE_2__);
Object(D_dev_cidr_xyz_node_modules_react_universal_component_dist_index_js__WEBPACK_IMPORTED_MODULE_2__["setHasBabelPlugin"])();var universalOptions={loading:function loading(){return null;},error:function error(props){console.error(props.error);return React.createElement("div",null,"An error occurred loading this page's template. More information is available in the console.");}};var t_0=D_dev_cidr_xyz_node_modules_react_universal_component_dist_index_js__WEBPACK_IMPORTED_MODULE_2___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({id:"../node_modules/react-static/lib/browser/components/Default404",load:function load(){return Promise.all([Promise.resolve(/* import() | node_modules-react-static-lib-browser-components-Default404 */).then(__webpack_require__.t.bind(null, 23, 7))]).then(function(proms){return proms[0];});},path:function path(){return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname,'../node_modules/react-static/lib/browser/components/Default404');},resolve:function resolve(){return /*require.resolve*/(23);},chunkName:function chunkName(){return"node_modules-react-static-lib-browser-components-Default404";}}),universalOptions);// Template Map
...
var _raf = _interopRequireDefault(__webpack_require__(20));
...
var _Location = _interopRequireDefault(__webpack_require__(22));
...
module.exports = require("netmask");
...
var _scrollTo = _interopRequireDefault(__webpack_require__(19));
...
var _Routes = _interopRequireDefault(__webpack_require__(21));
...
if (typeof document !== 'undefined' && module && module.hot) {
  module.hot.accept("D:\\dev\\cidr.xyz\\dist\\react-static-browser-plugins.js", function () {
...
if (typeof document !== 'undefined' && module && module.hot) {
  module.hot.accept("D:\\dev\\cidr.xyz\\dist\\react-static-templates.js", function () {
...
// Imports
exports.push([module.i, "@import url(https://fonts.googleapis.com/css?family=Ubuntu|Ubuntu+Mono);", ""]);

// Module
exports.push([module.i, "body, html, .container {\n  height: 100%;\n  width: 100%; }\n\nbody {\n  background: #eee;\n  font-family: 'Ubuntu', sans-serif;\n  max-width: 980px;\n  display: flex;\n  flex-direction: column;\n  margin: 0 auto; }\n  body .container {\n    margin: 0 auto; }\n  body header {\n    padding: 0 1em; }\n    body header h1 {\n      font-size: modular-scale(2); }\n      body header h1 small {\n        text-transform: uppercase;\n        color: #669;\n        display: block; }\n    body header p {\n      font-size: modular-scale(-1); }\n  body div.ip-address {\n    text-align: center;\n    font-family: 'Ubuntu Mono', monospace; }\n    body div.ip-address div {\n      margin-top: 65px; }\n    body div.ip-address div.address {\n      display: flex;\n      justify-content: center;\n      flex-wrap: wrap; }\n      body div.ip-address div.address input {\n        width: 2.5em;\n        font-size: 2.7em;\n        text-align: center;\n        border: 0px;\n        border-radius: 3px; }\n      body div.ip-address div.address > .octet,\n      body div.ip-address div.address .cidr {\n        margin: 10px; }\n      body div.ip-address div.address span.octet span.dot {\n        font-size: 2.7em;\n        text-align: center;\n        padding: 0.1em 0.13em; }\n      body div.ip-address div.address span.octet:nth-child(1) input.octet {\n        background-color: #a101a6; }\n      body div.ip-address div.address span.octet:nth-child(2) input.octet {\n        background-color: #d9005b; }\n      body div.ip-address div.address span.octet:nth-child(3) input.octet {\n        background-color: #84e900; }\n      body div.ip-address div.address span.octet:nth-child(4) input.octet {\n        background-color: #cff700; }\n      body div.ip-address div.address input.cidr {\n        background-color: #aaa; }\n    body div.ip-address div.bits ol {\n      display: flex;\n      justify-content: center;\n      flex-wrap: wrap;\n      padding: 0; }\n      body div.ip-address div.bits ol li.octet {\n        display: flex; }\n        body div.ip-address div.bits ol li.octet ol {\n          padding-left: 5px;\n          padding-right: 5px;\n          padding-bottom: 5px; }\n          body div.ip-address div.bits ol li.octet ol li.bit {\n            display: flex;\n            justify-content: center;\n            padding: 0.4em 0.6em;\n            margin-left: -1px;\n            border: 1px black solid; }\n        body div.ip-address div.bits ol li.octet:nth-child(1) ol li.bit.unmasked {\n          background-color: #eb01f2; }\n        body div.ip-address div.bits ol li.octet:nth-child(2) ol li.bit.unmasked {\n          background-color: #ff2781; }\n        body div.ip-address div.bits ol li.octet:nth-child(3) ol li.bit.unmasked {\n          background-color: #a8ff37; }\n        body div.ip-address div.bits ol li.octet:nth-child(4) ol li.bit.unmasked {\n          background-color: #e1ff45; }\n        body div.ip-address div.bits ol li.octet ol li.bit.masked {\n          background-color: #d0d0d0;\n          color: #e2e2e2; }\n    body div.ip-address div.details {\n      display: flex;\n      justify-content: space-evenly;\n      flex-wrap: wrap; }\n      body div.ip-address div.details > span {\n        padding: 15px; }\n      body div.ip-address div.details span.label {\n        display: block;\n        font-family: 'Ubuntu', sans-serif;\n        text-transform: uppercase;\n        font-size: modular-scale(2);\n        font-weight: bold;\n        color: #779; }\n  body footer {\n    bottom: 10px;\n    padding: 10px;\n    text-align: center;\n    margin-top: auto;\n    font-size: modular-scale(-1); }\n  @media screen and (max-width: 700px) {\n    body div.bits li.octet {\n      width: 100%; }\n      body div.bits li.octet ol {\n        padding-left: 20px !important;\n        padding-right: 20px !important;\n        width: 100%; }\n        body div.bits li.octet ol .bit {\n          flex-grow: 1; } }\n", ""]);
...
// EXTERNAL MODULE: D:/dev/cidr.xyz/src/style.scss
var style = __webpack_require__(38);

// EXTERNAL MODULE: external "react-ga"
var external_react_ga_ = __webpack_require__(13);
var external_react_ga_default = /*#__PURE__*/__webpack_require__.n(external_react_ga_);

// EXTERNAL MODULE: external "netmask"
var external_netmask_ = __webpack_require__(26);

// CONCATENATED MODULE: D:/dev/cidr.xyz/src/components/header.js
var header_Header=function Header(){return external_react_default.a.createElement("header",null,external_react_default.a.createElement("h1",null,"CIDR.xyz",external_react_default.a.createElement("small",null,"An interactive IP address and CIDR range visualizer")),external_react_default.a.createElement("p",null,external_react_default.a.createElement("a",{href:"https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing"},"CIDR")," ","is a notation for describing blocks of IP addresses and is used heavily in various networking configurations. IP addresses contain 4 octets, each consisting of 8 bits giving values between 0 and 255. The decimal value that comes after the slash is the number of bits consisting of the routing prefix. This in turn can be translated into a netmask, and also designates how many available addresses are in the block."));};/* harmony default export */ var header = (header_Header);
// CONCATENATED MODULE: D:/dev/cidr.xyz/src/components/footer.js
var footer_Footer=function Footer(){return external_react_default.a.createElement("footer",null,"Modified by ",external_react_default.a.createElement("a",{href:"https://github.com/jibin2706"},"Jibin Thomas"),". Source available on ",external_react_default.a.createElement("a",{href:"https://github.com/jibin2706/cidr.xyz"},"Github"),".");};/* harmony default export */ var footer = (footer_Footer);
// EXTERNAL MODULE: ../lib/index.js
var lib = __webpack_require__(27);

// CONCATENATED MODULE: D:/dev/cidr.xyz/src/components/meta.js
function _typeof(obj){if(typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"){_typeof=function _typeof(obj){return typeof obj;};}else{_typeof=function _typeof(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};}return _typeof(obj);}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}function _createClass(Constructor,protoProps,staticProps){if(protoProps)_defineProperties(Constructor.prototype,protoProps);if(staticProps)_defineProperties(Constructor,staticProps);return Constructor;}function _possibleConstructorReturn(self,call){if(call&&(_typeof(call)==="object"||typeof call==="function")){return call;}return _assertThisInitialized(self);}function _assertThisInitialized(self){if(self===void 0){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function _getPrototypeOf(o){_getPrototypeOf=Object.setPrototypeOf?Object.getPrototypeOf:function _getPrototypeOf(o){return o.__proto__||Object.getPrototypeOf(o);};return _getPrototypeOf(o);}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function");}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,writable:true,configurable:true}});if(superClass)_setPrototypeOf(subClass,superClass);}function _setPrototypeOf(o,p){_setPrototypeOf=Object.setPrototypeOf||function _setPrototypeOf(o,p){o.__proto__=p;return o;};return _setPrototypeOf(o,p);}// import { Helmet } from "react-helmet";
var meta_Meta=/*#__PURE__*/function(_Component){_inherits(Meta,_Component);function Meta(){_classCallCheck(this,Meta);return _possibleConstructorReturn(this,_getPrototypeOf(Meta).apply(this,arguments));}_createClass(Meta,[{key:"render",value:function render(){return external_react_default.a.createElement(lib["Head"],null,external_react_default.a.createElement("title",null,"CIDR - Classless Inter-Domain Routing"),external_react_default.a.createElement("meta",{name:"keywords",content:"cidr, ip address, range, netmask, visualizer, ip address calculator"}),external_react_default.a.createElement("meta",{name:"description",content:"Interactive IP address and CIDR range visualizer"}),external_react_default.a.createElement("meta",{name:"theme-color",content:"#666999"}));}}]);return Meta;}(external_react_["Component"]);/* harmony default export */ var meta = (meta_Meta);
// CONCATENATED MODULE: D:/dev/cidr.xyz/src/App.js
function App_typeof(obj){if(typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"){App_typeof=function _typeof(obj){return typeof obj;};}else{App_typeof=function _typeof(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};}return App_typeof(obj);}function _toConsumableArray(arr){return _arrayWithoutHoles(arr)||_iterableToArray(arr)||_nonIterableSpread();}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance");}function _iterableToArray(iter){if(Symbol.iterator in Object(iter)||Object.prototype.toString.call(iter)==="[object Arguments]")return Array.from(iter);}function _arrayWithoutHoles(arr){if(Array.isArray(arr)){for(var i=0,arr2=new Array(arr.length);i<arr.length;i++){arr2[i]=arr[i];}return arr2;}}function App_classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function App_defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}function App_createClass(Constructor,protoProps,staticProps){if(protoProps)App_defineProperties(Constructor.prototype,protoProps);if(staticProps)App_defineProperties(Constructor,staticProps);return Constructor;}function App_possibleConstructorReturn(self,call){if(call&&(App_typeof(call)==="object"||typeof call==="function")){return call;}return App_assertThisInitialized(self);}function App_getPrototypeOf(o){App_getPrototypeOf=Object.setPrototypeOf?Object.getPrototypeOf:function _getPrototypeOf(o){return o.__proto__||Object.getPrototypeOf(o);};return App_getPrototypeOf(o);}function App_inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function");}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,writable:true,configurable:true}});if(superClass)App_setPrototypeOf(subClass,superClass);}function App_setPrototypeOf(o,p){App_setPrototypeOf=Object.setPrototypeOf||function _setPrototypeOf(o,p){o.__proto__=p;return o;};return App_setPrototypeOf(o,p);}function App_assertThisInitialized(self){if(self===void 0){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function initializeReactGA(){external_react_ga_default.a.initialize("UA-133322442-2");external_react_ga_default.a.pageview("/");}var App_App=/*#__PURE__*/function(_Component){App_inherits(App,_Component);function App(props){var _this;App_classCallCheck(this,App);_this=App_possibleConstructorReturn(this,App_getPrototypeOf(App).call(this,props));_this.state={octets:[10,88,135,144],cidr:28};_this.handleChange=_this.handleChange.bind(App_assertThisInitialized(App_assertThisInitialized(_this)));_this.handleKeyDown=_this.handleKeyDown.bind(App_assertThisInitialized(App_assertThisInitialized(_this)));return _this;}App_createClass(App,[{key:"componentDidMount",value:function componentDidMount(){initializeReactGA();}},{key:"handleChange",value:function handleChange(event){var octets=this.state.octets;var val=+event.target.value.replace(/[^0-9]/g,"");var octet=event.target.attributes["data-octet"].value;if(octet==="cidr"){if(val<=32){this.setState({cidr:val});}}else if(val<=255){octets[+octet]=val;this.setState({octets:octets});}}},{key:"handleKeyDown",value:function handleKeyDown(event){var lowerOctetValue=0;var higherOctetValue=event.target.dataset.octet==="cidr"?32:255;if(event.key==="ArrowDown"&&event.target.value>lowerOctetValue){event.target.value=+event.target.value-1;this.handleChange(event);}if(event.key==="ArrowUp"&&event.target.value<higherOctetValue){event.target.value=+event.target.value+1;this.handleChange(event);}}},{key:"getPretty",value:function getPretty(){return"".concat(this.state.octets.join(".")," / ").concat(this.state.cidr);}},{key:"render",value:function render(){var _this2=this;var details=new external_netmask_["Netmask"](this.getPretty());return external_react_default.a.createElement(external_react_default.a.Fragment,null,external_react_default.a.createElement(meta,null),external_react_default.a.createElement("div",{className:"container"},external_react_default.a.createElement(header,null),external_react_default.a.createElement("div",{className:"ip-address"},external_react_default.a.createElement("div",{className:"address"},_toConsumableArray(Array(4)).map(function(x,octet){return external_react_default.a.createElement("span",{className:"octet"},external_react_default.a.createElement("input",{className:"octet",type:"text","data-octet":octet,onChange:_this2.handleChange,onKeyDown:_this2.handleKeyDown,value:_this2.state.octets[octet]}),external_react_default.a.createElement("span",{className:"dot"},octet===3?"/":"."));}),external_react_default.a.createElement("input",{className:"cidr",type:"text","data-octet":"cidr",onChange:this.handleChange,onKeyDown:this.handleKeyDown,value:this.state.cidr})),external_react_default.a.createElement("div",{className:"bits"},external_react_default.a.createElement("ol",null,_toConsumableArray(Array(4)).map(function(x,octet){return external_react_default.a.createElement("li",{className:"octet"},external_react_default.a.createElement("ol",null,_toConsumableArray(Array(8)).map(function(x,bit){return external_react_default.a.createElement("li",{className:octet*8+bit>_this2.state.cidr-1?"bit masked":"bit unmasked"},(_this2.state.octets[octet]&1<<7-bit)>>7-bit);})));}))),external_react_default.a.createElement("div",{className:"details"},external_react_default.a.createElement("span",{className:"netmask"},external_react_default.a.createElement("span",{className:"value"},details.mask),external_react_default.a.createElement("span",{className:"label"},"Netmask")),external_react_default.a.createElement("span",{className:"first"},external_react_default.a.createElement("span",{className:"value"},details.first),external_react_default.a.createElement("span",{className:"label"},"First IP")),external_react_default.a.createElement("span",{className:"last"},external_react_default.a.createElement("span",{className:"value"},details.last),external_react_default.a.createElement("span",{className:"label"},"Last IP")),external_react_default.a.createElement("span",{className:"count"},external_react_default.a.createElement("span",{className:"value"},details.size.toLocaleString()),external_react_default.a.createElement("span",{className:"label"},"Count")))),external_react_default.a.createElement(footer,null)));}}]);return App;}(external_react_["Component"]);/* harmony default export */ var src_App = (App_App);
// CONCATENATED MODULE: D:/dev/cidr.xyz/src/index.js
...
//# sourceMappingURL=static.d400b1af.js.map